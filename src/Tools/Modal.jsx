      ...
      {isOpen && (
        ...
        >
          <motion.div
            ...
            className=" bg-black h-[40vh] w-full md:h-[50vh] md:w-[70vh] lg:h-[55vh] lg:w-[80vh]  text-white   rounded-lg  max-w-lg shadow-xl cursor-default relative overflow-hidden"
          >
